...
* Create Repository via the following [URL](https://github.com/new)
  * Set repository name to ESPAdapters 
...
* On your local system execute the following commands in the project directory:
    ...
    git branch -M main
    git remote add origin https://github.com/jexxa-projects/ESPAdapters
    ```
...
*   [mavenBuild.yml](https://github.com/jexxa-projects/ESPAdapters/actions/workflows/mavenBuild.yml):
    *   __Description:__ Builds the project after each push
    *   __Started:__ Automatically and manually   

*   [unreleased_changes.yml](https://github.com/jexxa-projects/ESPAdapters/actions/workflows/unreleased_changes.yml):
...
*   [newRelease.yml](https://github.com/jexxa-projects/ESPAdapters/actions/workflows/newRelease.yml):
...
*   [autoMerge.yml](https://github.com/jexxa-projects/ESPAdapters/actions/workflows/autoMerge.yml):
...
*   [dependabot.yml](https://github.com/jexxa-projects/ESPAdapters/actions/workflows/dependabot.yml):
...
```shell
docker stack deploy --compose-file ./deploy/docker-compose.yml espadapters
```
